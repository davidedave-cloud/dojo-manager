  ...
  <div style="max-width:540px;margin:32px auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e0d8c8;">
    ...
    <div style="padding:32px;">
      ...
      <div style="text-align:center;margin-bottom:8px;">
        <a href="${PORTAL_URL}" style="display:inline-block;background:linear-gradient(135deg,#b8860b,#daa520);color:#0d0d0d;text-decoration:none;border-radius:10px;padding:12px 24px;font-weight:700;font-size:14px;font-family:Georgia,serif;white-space:nowrap;mso-padding-alt:12px 24px;">
