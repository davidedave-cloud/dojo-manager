...
<body style="margin:0;padding:0;background:#f5f5f0;font-family:Georgia,serif;">
  <div style="max-width:540px;margin:32px auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e0d8c8;">
    ...
    <div style="padding:32px;">
      ...
      <div style="background:#f9f6f0;border-radius:10px;padding:20px;margin-bottom:24px;">
        <div style="font-size:11px;color:#888;margin-bottom:14px;text-transform:uppercase;letter-spacing:0.1em;">📋 Regolamento</div>
        <ul style="font-size:13px;color:#555;line-height:1.9;margin:0;padding-left:18px;">
          <li>Presentarsi puntualmente con il kimono pulito e in ordine</li>
          <li>Il certificato medico agonistico è obbligatorio per legge</li>
          <li>Rispettare istruttori e compagni di allenamento</li>
          <li>In caso di assenza prolungata avvisare il Sensei</li>
          <li>La quota mensile è dovuta anche in caso di assenze occasionali</li>
        </ul>
      </div>
