        ...
        {activeTab === "documenti" && (
          <div>
            ...
            {[athlete, ...familyMembers].map(m => {
              ...
              return (
                <div key={m.id} style={{ background: "#131008", border: `1px solid ${statoColore}44`, borderRadius: 14, padding: 20, marginBottom: 14 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 10 }}>
                    <div>
                      <div style={{ fontSize: 15, fontWeight: 700, color: "#e8e0d0" }}>
                        {m.first_name} {m.last_name}
                        {m.id === athlete.id && <span style={{ fontSize: 11, color: "#daa520", background: "rgba(218,165,32,0.1)", padding: "2px 8px", borderRadius: 99, marginLeft: 8 }}>Tu</span>}
                      </div>
