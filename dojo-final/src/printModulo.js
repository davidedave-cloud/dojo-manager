...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .logo { font-size: 22pt; font-weight: bold; color: #1a6bbf; letter-spacing: 2px; }
  .titolo { font-size: 14pt; font-weight: bold; color: #1a6bbf; margin: 6px 0 2px; }
  .sottotitolo { font-size: 9pt; font-style: italic; margin-bottom: 10px; }
  .num-iscrizione { text-align: right; font-size: 9pt; margin-bottom: 8px; }
  .intestazione { text-align: center; margin: 8px 0 10px; font-size: 10pt; }
  .riga { display: flex; align-items: flex-end; margin-bottom: 7px; gap: 6px; }
  ...
  .sezione { margin: 10px 0 6px; text-align: center; font-size: 10pt; font-weight: bold; }
  .testo { font-size: 9pt; line-height: 1.5; margin-bottom: 6px; text-align: justify; }
  .firma-riga { display: flex; justify-content: flex-end; margin: 8px 0 6px; gap: 8px; align-items: flex-end; }
  .firma-label { font-size: 9pt; white-space: nowrap; }
  .firma-linea { border-bottom: 1px solid #000; width: 220px; }
  .consenso-blocco { margin: 8px 0; }
  .consenso-riga { display: flex; align-items: center; gap: 16px; margin: 4px 0; }
  .checkbox-gruppo { display: flex; align-items: center; gap: 6px; }
  .checkbox { display: inline-block; width: 14px; height: 14px; border: 1px solid #000; vertical-align: middle; flex-shrink: 0; }
  .dichiaro-inoltre { font-weight: bold; text-align: center; margin: 8px 0 4px; font-size: 10pt; }
